            ...
            -->
                    <div class="alert alert-danger" ng-show="contactForm.$invalid">
                        <ul>
                            ...
                            <!-- Thông báo lỗi Tel -->
                            <li><span class="error" ng-show="contactForm.tel.$error.required">Vui nhập số điện thoại</span></li>
                            <li><span class="error" ng-show="contactForm.tel.$error.minlength">Số điện thoại phải >= 9 số</span></li>
                            <li><span class="error" ng-show="contactForm.tel.$error.maxlength">Số điện thoại phải < 16 số</span></li>
                            ...
                            <li><span class="error" ng-show="contactForm.message.$error.maxlength">Lời nhắn phải <= 250 ký tự</span> </li> </li> </div> <!-- Div Thông báo validate hợp lệ Chỉ hiển thị khi các validate trong form `contactForm` không hợp lệ=> contactForm.$valid = true
                                        ...
                                        <!-- Validate tel -->
                                        <div class="bor8 m-b-20 how-pos4-parent">
                                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="tel" placeholder="Số điện thoại của bạn" ng-model="tel" ng-required=true ng-minlength="9" ng-maxlength="15">
                                            <span class="valid" ng-show="userInfo.tel.$valid">Hợp lệ</span>
                                            <img class="how-pos4 pointer-none" src="{{ asset('themes/cozastore/images/icons/icon-email.png') }}" alt="ICON">
                                        </div>
        ...
        $scope.submitContactForm = function() {
            ...
            if ($scope.contactForm.$valid) {
                ...
                var dataInputContactForm = {
                    ...
                    "tel": $scope.contactForm.tel.$viewValue,
