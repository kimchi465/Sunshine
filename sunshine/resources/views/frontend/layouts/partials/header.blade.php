                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li class="{{ Request::is('') ? 'active-menu' : '' }}">
                            <a href="{{ route('frontend.home') }}">{{ __('sunshine.pages.home') }}</a>
                        </li>

                        <li>
                            <a href="product.html">{{ __('sunshine.pages.shop')}}</a>
                        </li>

                        <li class="label1" data-label1="hot">
                            <a href="shoping-cart.html">{{ __('sunshine.pages.features')}}</a>
                        </li>

                        <li>
                            <a href="blog.html">{{ __('sunshine.pages.blog')}}</a>
                        </li>
                        <li class="{{ Request::is('san-pham') ? 'active-menu' : '' }}">
                        <a href="{{ route('frontend.product') }}">{{ __('sunshine.pages.product') }}</a>
                        </li>
        ...
        <ul class="topbar-mobile">
            ...
            <li>
                <div class="right-top-bar flex-w h-full">
                    ...
                    <a href="{{ route('app.setLocale', ['locale' => 'en']) }}" class="flex-c-m p-lr-10 trans-04">
                        EN
                    </a>
                    <a href="{{ route('app.setLocale', ['locale' => 'vi']) }}" class="flex-c-m p-lr-10 trans-04">
                        VI
                    </a>
